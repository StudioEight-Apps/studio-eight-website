...
const Whisper = () => {
  return (
    <div className="relative min-h-screen bg-[#F6F1EA]">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-4 bg-[#F6F1EA]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <span className="text-xl font-medium italic text-[#1a1a1a]">Whisper</span>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-start pt-28 md:pt-32 px-6 overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 md:mt-14">
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#1a1a1a] text-white px-6 md:px-8 py-3 md:py-4 rounded-full text-sm md:text-base font-medium hover:bg-[#1a1a1a]/90 transition-all duration-300 hover:scale-[1.02]"
            >
        ...
        {/* iPhone Mockup - Using actual screenshot with frame */}
        <div className="relative z-10 mt-12 md:mt-16 w-full max-w-[280px] md:max-w-[380px] lg:max-w-[420px] overflow-hidden" style={{ height: 'auto', maxHeight: '50vh' }}>
          <img 
            src={whisperMockup} 
          ...
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#F6F1EA] to-transparent pointer-events-none" />
        </div>
      </section>
